...
admin_externalpage_setup('inactive_user_cleanup');
...
if(!empty($configdata->daysbeforedeletion)) {
    ...
    $data->config_inactiveorsuspended = $configdata->inactiveorsuspended;
    $data->config_deleteoranon = $configdata->deleteoranon;
...
if ($emailform->is_submitted()) {
    ...
    set_config('inactiveorsuspended', $fromdata->config_inactiveorsuspended, 'tool_inactive_user_cleanup');
    set_config('deleteoranon', $fromdata->config_deleteoranon, 'tool_inactive_user_cleanup');
