...
if ($hassiteconfig) {
    // TODO: I feel this tool fits better next to the server cleanup tasks.
    $ADMIN->add('server',
        new admin_externalpage('inactive_user_cleanup', get_string('pluginname', 'tool_inactive_user_cleanup'),
